        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                <?php $u_id = urlencode(base64_encode($user['id']));
                 echo form_open_multipart('user-edit/'.$u_id, array('id' => 'demo-form2','class'=>'form-horizontal form-label-left')); ?>
                 <?php if($this->session->flashdata('error')){ ?>
                ...
                <div class="col-md-6">
                    <div class="item form-group">
                        ...
                        <div class="col-md-9 col-sm-9">
                            <input type="text" name="username" value="<?php echo ($this->input->post('username') ? $this->input->post('username') : $user['username']); ?>" id="username" class="form-control">
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-9 col-sm-9">
                            <input name="name" value="<?php echo ($this->input->post('name') ? $this->input->post('name') : $user['name']); ?>" type="text" id="name" class="form-control">
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-9 col-sm-9">
                            <input type="email" name="email" value="<?php echo ($this->input->post('email') ? $this->input->post('email') : $user['email']); ?>" id="email" placeholder="Admin Email" class="form-control ">
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-9 col-sm-9">
                            <select name="is_admin" class="form-control" id="is_admin">
                                ...
                                $selected = ($key == $user['is_admin']) ? ' selected="selected"' : "";
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-9 col-sm-9">
                            <select name="status" class="form-control" id="status">
                                ...
                                $selected = ($key == $user['status']) ? ' selected="selected"' : "";
                                echo '<option value="'.$value.'" '.$selected.'>'.$key.'</option>';
                                }?>
                            </select>
                        </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        $user_permit = explode(',',$user['permissions']);
                            foreach($permissions as $key => $p)
                            {
                                $selected = '';
                                foreach($user_permit as $permit){
                                    if($p==$permit || $permit=='select_all')
                                    $selected = "selected";
                                }
