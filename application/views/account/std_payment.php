<div class="container" style="margin:30px 0;max-width: 100%;">
  <div class="row">
    <!-- <div class="col-sm-1"></div> -->
  	<div class="col-md-12">
  		<h3 style="color: gray">Student Payment Report</h3>
      <div class="x_panel" style="padding: 0;box-shadow: 0 0 5px gray;border-bottom: 15px solid #2A3F54">
        ...
        <div class="x-content" style="padding: 10px">
          <?php echo form_open('student-payment-report'); ?>
          <div class="row">
              ...
              <div class="form-group">
                <select name="student_id" class="form-control select2">
                    ...
                    foreach($results as $r)
                    {
                        ...
                        echo '<option value="'.$r['id'].'" '.$selected.'>'.$r['id'].' - Name: '.$r['std_name'].
                        ' - Father: '.$r['father_name'].' - Roll: '.$r['roll_no'].' - Cell: '.$r['phone'].'</option>';
                    }
                    ?>
                </select>
