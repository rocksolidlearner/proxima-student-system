...
<div class="row">
    <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
            <div class="x_title">
                <h2><i class="fa fa-pencil"></i> Edit Course Material</h2>
            ...
            <div class="x_content">
                <?php $id = urlencode(base64_encode($course['id']));
                echo form_open_multipart('course-edit/'.$id); ?>
                <div class="row">
                    <div class="col-md-6 col-sm-12">
                        <div class="item form-group">
                            ...
                            <div class="col-md-10 col-sm-9">
                                <div class="input-group">
                                    <input type="text" name="course_name" class="form-control" value="<?=($this->input->post('course_name') ? $this->input->post('course_name') : $course['course_name']);?>" >
                                </div>
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-10 col-sm-9">
                                <div class="input-group">
                                    <textarea name="description" rows="10" class="form-control" style="resize: none;" placeholder="Description..."><?=($this->input->post('description') ? $this->input->post('description') : $course['description']);?></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-12"> -->
                        <div class="form-group">
                            ...
                            <select multiple="multiple" size="10" name="subjects[]" class="form-control dual_listbox" style="height: 150px">
                                ...
                                {
                                    $selected = '';
                                    foreach($c_subject as $cs){
                                        if($cs['subject_id'] == $s['id']){
                                            $selected ="selected";
                                        }
                                    }
