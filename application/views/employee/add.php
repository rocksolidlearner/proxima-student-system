...
<!-- <div class="row"> -->
    <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
            <div class="x_title">
                <h2><i class="fa fa-plus"></i> Add Other Empoyees</h2>
                <div class="clearfix"></div>
            </div>
            <div class="x_content">
                <?php echo form_open_multipart('employee-add', array('id' => 'demo-form2','class'=>'form-horizontal form-label-left')); ?>
                <div class="row">
                    <div class="col-md-8">
                        <div class="item form-group">
                            ...
                            <div class="col-md-8 col-sm-8">
                                <input name="employee_name" placeholder="Empoyee name required" value="<?php echo $this->input->post('employee_name'); ?>" type="text" class="form-control">
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-8 col-sm-8">
                                <input name="phone" placeholder="+44" maxlength="15" value="+44<?php echo $this->input->post('phone'); ?>" type="text" class="form-control">
