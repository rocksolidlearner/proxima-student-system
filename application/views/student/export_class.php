    ...
    <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
            ...
            <div class="x_content">
                <div class="row">
                    <div class="col-sm-12">
                    <?php echo form_open('classes-export'); ?>
                        <div class="item form-group">
                            <label class="col-sm-3 control-label text-right">Class Name</label>
                            <div class="col-sm-6">
                                    ...
                                    <?php foreach($classes as $c)
                                        {
                                            ...
                                            echo '<option value="'.$c['id'].'" '.$selected.'>'.$c['batch_name'].' >> '.$c['class_name'].' ('.$c['stdents'].' Students)</option>';
                                        } ?>
                                </select>
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6">
                                <button class="btn btn-primary" type="submit">Export Class</button>
                            </div>
                        </div>
                        <?=form_close();?>
                    </div>
