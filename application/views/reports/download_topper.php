...
<div class="container" style="margin: 10px 0px;max-width: 100%!important">
  ...
  <table class="table table-bordered" style="width: 100% !important;border-collapse: collapse;border-spacing: 2px;border: 1px solid #dee2e6;">
    ...
    <tr>
        ...
        <th style="display: table-cell;font-weight: bold;padding: 0.55rem;border: 1px solid #dee2e6;text-align: inherit;font-size: x-small;">Obtained Marks</th>
    ...
    <tr>
      ...
      <td style="padding: 0.55rem;border: 1px solid #dee2e6;font-size: x-small;"><?=$m['marks'];?></td>
