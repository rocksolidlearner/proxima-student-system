        ...
        <div class="x_panel">
            <div class="x_title">
                ...
                <ul class="nav navbar-right panel_toolbox">
                    ...
                    <?php echo form_open('fee-defaulters'); ?>
                    <li>
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <select class="form-control select2" name="phone_number" style="width: 100%">
                        ...
                        echo'<option value="'.$std['phone'].'">Student '.$std['phone'].'</option>';
                        }?>
                    </select>
...
<script>
    function edit_fee(id) {
		$('#editModal').modal();
		$.ajax({
            url: "<?=base_url('fee/edit_model/')?>"+id+"/<?=DEFAULTER?>",
    ...
    function pay_fee(id) {
		$('#payModal').modal();
		$.ajax({
            url: "<?=base_url('fee/pay_model/')?>"+id+"/<?=DEFAULTER?>",
            success: function (data) {
                console.log('success');
                $('#pay_data').html(data);
